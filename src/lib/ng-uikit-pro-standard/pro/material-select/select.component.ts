  ...
  implements ControlValueAccessor, OnChanges, OnInit, AfterViewInit
{
  ...
  @Output() deselected: EventEmitter<IOption | IOption[]> = new EventEmitter<
    IOption | IOption[]
  >();
  ...
  ngAfterViewInit() {
    ...
    this.renderer.setStyle(
      this.selectionSpan.nativeElement.children[0].lastChild,
      "visibility",
      "hidden"
    );
  }
  ...
  setArrowUpIcon() {
    ...
    this.renderer.appendChild(
      this.selectionSpan.nativeElement.children[0],
      div
    );
  ...
  updatePosition() {
    ...
    const dropdownHeight =
      this.dropdownMaxHeight > this.dropdownHeight
        ? this.dropdownHeight
