...
export class CompleterComponent
  implements OnInit, ControlValueAccessor, AfterViewChecked, AfterViewInit
{
  ...
  public set textNoResults(text: string) {
    if (this._textNoResults !== text) {
      ...
      this.displayNoResults =
        this._textNoResults && this._textNoResults !== "false";
    }
  }
  ...
  public set textSearching(text: string) {
    if (this._textSearching !== text) {
      ...
      this.displaySearching =
        this._textSearching && this._textSearching !== "false";
    }
  }
